            ...
            <form class="form-horizontal" method="post" @submit.prevent="onSubmit">
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-9" :class="{'has-error': errors.name}">
                            <input id="name"
                    ...
                    <div class="form-group">
                        <label class="col-3 control-label" for="email">Your E-mail</label>
                        <div class="col-9" :class="{'has-error': errors.email}">
                            <input id="email"
                    ...
                    <div class="form-group">
                        <label class="col-3 control-label" for="body">Your message</label>
                        <div class="col-9" :class="{'has-error': errors.body}">
